...
| [@pyreon/create-zero](https://www.npmjs.com/package/@pyreon/create-zero) | Create a new Pyreon project — invoke as `create-pyreon-app` (canonical) or `create-zero` (alias) |
| [create-weave](https://www.npmjs.com/package/create-weave) | Scaffold a new Weave app — `npm create weave my-app` (also pnpm/yarn create). |
...
| [create-wattpm](https://www.npmjs.com/package/create-wattpm) | Create platformatic application interactive tool |
